...
const DefaultMetasTag = () => {
  return (
    <Helmet>
      {/* <title>Tienda Online de Alimentos y Comida para comprar en Chile | La Mesa de Todos</title> */}
      {/* navegador */}
      <meta name="robots" content="index" />
      <meta name="title" content="Tienda Online de Alimentos y Comida para comprar en Chile" />
      {/* <meta name="description" content="Entra a nuestra Tienda Online de Alimentos y Comida. Descubre las categorías y productos que te ofrecemos. ¡Puedes comprar con Despacho en Santiago!" /> */}
      ...
      {/* opengraph */}
      <meta property="og:title" content="Tienda Online de Alimentos y Comida para comprar en Chile" />
      <meta
      ...
      <meta name="twitter:title" content="Tienda Online de Alimentos y Comida para comprar en Chile" />
      <meta
...
export default DefaultMetasTag;
