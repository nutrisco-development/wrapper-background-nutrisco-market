        ...
        <div className={handles.RecipeFoodGrid}>
          <div className={handles.RecipeFoodGridItem1}>
            <div className={handles.RecipeFoodGridItem1Box}>
              <img
                alt="arroz cremoso de jurel"
                src="https://orizonb2ccl.vtexassets.com/arquivos/COVER-ARROZ-CREMOSO-DE-JUREL-2023.jpg"
            ...
            <div className={handles.RecipeFoodGridItem2Box}>
              <div className={handles.RecipeFoodGridItem2Divider}>
                ...
                <div>
                  ...
                  <ul className={handles.RecipeFoodIngredientsList}>
                    <li className={handles.RecipeFoodIngredientsListItem}>1.&nbsp;1 tarro jurel conserva bajo en sodio</li>
                    <li className={handles.RecipeFoodIngredientsListItem}>2.&nbsp;1/2 taza(s) arroz</li>
                    <li className={handles.RecipeFoodIngredientsListItem}>3.&nbsp;1/2 taza(s) arvejas</li>
                    <li className={handles.RecipeFoodIngredientsListItem}>4.&nbsp;1/2 un cebolla</li>
                    <li className={handles.RecipeFoodIngredientsListItem}>5.&nbsp;1 taza(s) vino blanco</li>
                    <li className={handles.RecipeFoodIngredientsListItem}>6.&nbsp;1 diente(s) ajo</li>
                    <li className={handles.RecipeFoodIngredientsListItem}>7.&nbsp;1 taza(s) crema de leche</li>
                    <li className={handles.RecipeFoodIngredientsListItem}>8.&nbsp;1/2 taza(s) queso parm rallado</li>
                    <li className={handles.RecipeFoodIngredientsListItem}>9.&nbsp;2 un limón</li>
                    <li className={handles.RecipeFoodIngredientsListItem}>10.&nbsp;1/4 cdta(s) sal</li>
                    <li className={handles.RecipeFoodIngredientsListItem}>11.&nbsp;2 cda(s) aceite oliva</li>
                  </ul>
                </div>
              </div>
              ...
              <ul className={handles.RecipeFoodInstructionsList}>
                <li className={handles.RecipeFoodInstructionsListItem}>
                  <p>1.&nbsp;Cocinar el arroz según las indicaciones del envase. Cortar ajo y cebolla en cubitos, reservar.</p>
                </li>
                <li className={handles.RecipeFoodInstructionsListItem}>
                  <p>
                    2.&nbsp;Cocinar arvejas en agua hirviendo con sal. Una vez listas escurrir y reservar. Para el arroz cremoso, primero
                    sofreír en aceite de oliva los vegetales, luego añadir el jurel al natural bajo en sodio San José® y apagar con vino
                    blanco, dejar reducir y agregar el arroz.
                  </p>
                </li>
                <li className={handles.RecipeFoodInstructionsListItem}>
                  <p>
                    3.&nbsp;Después de que evapore un poco el líquido agregar crema, queso, arvejas, ralladura de limón, sal y pimienta.
                    Mezclar bien hasta obtener consistencia cremosa, añadir unas gotas de limón y a disfrutar.
                  </p>
                </li>
              </ul>
            </div>
...
export default ArrozCremosoJurel;
