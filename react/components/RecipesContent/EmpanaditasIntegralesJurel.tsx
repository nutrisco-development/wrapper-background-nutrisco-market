...
const EmpanaditasIntegralesJurel = () => {
        ...
        <div className={handles.RecipeFoodGrid}>
          <div className={handles.RecipeFoodGridItem1}>
            <div className={handles.RecipeFoodGridItem1Box}>
              <img
                alt=""
                src="https://orizonb2ccl.vtexassets.com/arquivos/empanadajurel.jpg"
            ...
            <div className={handles.RecipeFoodGridItem2Box}>
              <div className={handles.RecipeFoodGridItem2Divider}>
                ...
                <div>
                  ...
                  <ul className={handles.RecipeFoodIngredientsList}>
                    <li className={handles.RecipeFoodIngredientsListItem}>1.&nbsp;1 tarro de jurel lomitos al natural San José.</li>
                    <li className={handles.RecipeFoodIngredientsListItem}>2.&nbsp;½ cebolla.</li>
                    <li className={handles.RecipeFoodIngredientsListItem}>3.&nbsp;¼ pimentón.</li>
                    <li className={handles.RecipeFoodIngredientsListItem}>4.&nbsp;½ taza de perejil.</li>
                    <li className={handles.RecipeFoodIngredientsListItem}>5.&nbsp;½ taza de vino blanco.</li>
                    <li className={handles.RecipeFoodIngredientsListItem}>6.&nbsp;1 cucharadita de ají de color.</li>
                    <li className={handles.RecipeFoodIngredientsListItem}>7.&nbsp;1 cucharada de orégano.</li>
                    <li className={handles.RecipeFoodIngredientsListItem}>8.&nbsp;1 huevo.</li>
                    <li className={handles.RecipeFoodIngredientsListItem}>9.&nbsp;1 ½ taza de harina integral.</li>
                    <li className={handles.RecipeFoodIngredientsListItem}>10.&nbsp;Aceite de oliva.</li>
                    <li className={handles.RecipeFoodIngredientsListItem}>11.&nbsp;Sal.</li>
                  </ul>
                </div>
              </div>
              ...
              <ul className={handles.RecipeFoodInstructionsList}>
                <li className={handles.RecipeFoodInstructionsListItem}>
                  <p>
                    1. Sofreír la cebolla en cubitos en aceite de oliva, cuando esté semi translucida agregar el pimentón en cubitos, dorar
                    las verduras. Agregar un chorrito de vino blanco, el jurel y perejil, aliñar con el ají color, orégano y sal.
                  </p>
                </li>
                <li className={handles.RecipeFoodInstructionsListItem}>
                  <p>2. Cocinar hasta que se evapore el vino. Dejar enfriar.</p>
                </li>
                <li className={handles.RecipeFoodInstructionsListItem}>
                  <p>
                    3. Para la masa, mezclar la harina con un buen chorro de oliva, sal fina e ir de apoco agregando agua hasta poder
                    trabajar la masa. Amasar unos minutos y dividir la masa en 6.
                  </p>
                </li>
                <li className={handles.RecipeFoodInstructionsListItem}>
                  <p>
                    4. Hacer bollitos y extender con la ayuda de un uslero, rellenar la empanada y cerrarla con un poco de agua en los
                    bordes para que junte bien. Poner las empanadas en una lata de horno, pintar con huevo batido y agregar orégano.
                  </p>
                </li>
                <li className={handles.RecipeFoodInstructionsListItem}>
                  <p>5. Hornear hasta que estén bien doradas.</p>
                </li>
              </ul>
